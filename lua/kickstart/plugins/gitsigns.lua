...
return {
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        end, { desc = 'Git [s]tage hunk (visual)' })
        
        map('v', '<leader>hr', function() 
          gitsigns.reset_hunk { vim.fn.line '.', vim.fn.line 'v' } 
        end, { desc = 'Git [r]eset hunk (visual)' })
        ...
        -- Additional convenience mappings for better workflow
        ...
        map('n', '<leader>gl', function() gitsigns.blame_line { full = true } end, { desc = '[G]it b[l]ame line' })
      end,
    },
  },
}
